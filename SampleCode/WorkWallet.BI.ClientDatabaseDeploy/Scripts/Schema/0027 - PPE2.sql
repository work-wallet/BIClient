...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'mart.PPEPropertyType') AND type = N'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'mart.PPEProperty') AND type = N'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'mart.PPEPropertyFact') AND type = N'U')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'mart.PPEGroupFact') AND type = N'U')
BEGIN
